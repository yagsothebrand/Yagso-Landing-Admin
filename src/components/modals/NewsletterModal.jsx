      ...
      >
        ...
        <button
          ...
          style={{
            ...
            top: "1rem",
            right: "1rem",
            backgroundColor: isHovering ? "rgba(0, 0, 0, 0.15)" : "rgba(0, 0, 0, 0.08)",
            borderRadius: "50%",
            padding: "0.5rem",
            border: "none",
            cursor: "pointer",
        ...
        {!submitted ? (
          <div style={{ padding: "2.5rem 2rem", textAlign: "center", position: "relative" }}>
            {/* Floating Sparkles */}
            <Sparkles className="sparkle" style={{ top: "20px", left: "30px", color: "#edd7c8" }} size={24} />
            <Sparkles className="sparkle" style={{ top: "40px", right: "40px", color: "#d4a89f" }} size={20} />
            <Sparkles className="sparkle" style={{ bottom: "100px", left: "50px", color: "#133827", opacity: 0.6 }} size={18} />
            ...
            <p style={{
              ...
              Weekly inspo, exclusive drops & VIP perks delivered straight to your inbox
            </p>
            ...
            <div style={{ position: "relative", marginBottom: "1rem" }}>
              <input
                ...
                style={{
                  ...
                  fontSize: "0.95rem",
                  border: touched ? (isValid ? "2px solid #0f5132" : "2px solid #dc2626") : "2px solid #e5e7eb",
            ...
            <button
              ...
              style={{
                ...
                transition: "all 0.2s ease",
                boxShadow: isValid ? "0 4px 15px rgba(19, 56, 39, 0.3)" : "none"
              }}
            >
              Let's go 🚀
            </button>
