            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-white">
                ...
                >
                  ...
                  <span className="relative inline-block text-[#cdb1a5]">
                    luxury
                    <span
                ...
                >
                  ...
                  We're opening our doors to a select few. Request access to
                  shop our launch collection before anyone else.
                </motion.p>
                ...
                >
                  <div className="flex flex-col sm:flex-row gap-3 max-w-xl">
                    <Input
                      ...
                      required
                      className="h-14 px-5 rounded-full text-[15px] font-medium transition-all placeholder:text-gray-300 duration-200"
                      style={{
                        background: `#ffffff`,
                    ...
                    <Button
                      ...
                      style={{
                        background: `linear-gradient(135deg, #cdb1a5 0%, #cdb1a5 100%)`,
                        color: CREAM,
                        border: `1px solid ${BRAND}40`,
                      }}
                    >
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    <div
                      ...
                      style={{
                        background: `linear-gradient(135deg, ${BRAND}30 0%, #cdb1a5 100%)`,
                        border: `1px solid ${BRAND}40`,
                      }}
                    >
                      <svg
