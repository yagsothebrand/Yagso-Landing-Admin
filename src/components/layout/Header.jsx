...
export function Header({ onProfileClick }) {
  ...
  return (
    <header className="border-b border-gray-200 sticky top-0 z-40 shadow-sm backdrop-blur-sm ">
        ...
        <div className="flex items-center justify-between pl-10 sm:pl-12 lg:pl-0 gap-2 sm:gap-3">
          ...
          >
            <div className="min-w-0 pl-5">
              <h1 className="text-base text-green-900 font-medium sm:block truncate">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="relative flex-shrink-0">
                      {!user?.profileImage ? (
                        <div className="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 rounded-full bg-gradient-to-br from-green-700 to-green-800 flex items-center justify-center text-white font-semibold text-sm sm:text-sm border-2 border-blue-100">
                          {initials}
                        </div>
                      ) : (
                        <img
                  ...
                  <AnimatePresence>
                    {showUserMenu && (
                      <>
                        ...
                        >
                          {/* User Info Card */}
                          <div className="p-3 sm:p-4 bg-gradient-to-br from-green-70 to-blue-100 border-b border-blue-200">
                            <div className="flex items-center gap-2 sm:gap-3">
                              {!user?.profileImage ? (
                                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-green-700 to-green-800 flex items-center justify-center text-white font-bold text-base sm:text-lg border-2 border-white shadow-sm flex-shrink-0">
                                  {initials}
                                </div>
                              ) : (
                                <img
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mt-1">
                                  <Badge className="bg-green-800 text-white text-sm px-1.5 sm:px-2 py-0 hover:bg-green-800 whitespace-nowrap">
                                    {user?.role}
                                  </Badge>
                          ...
                          <div className="p-2">
                            ...
                            >
                              <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                <User className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-green-800" />
                              </div>
